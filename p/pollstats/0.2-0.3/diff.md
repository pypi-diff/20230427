# Comparing `tmp/pollstats-0.2.tar.gz` & `tmp/pollstats-0.3.tar.gz`
...
## Comparing `pollstats-0.2.tar` & `pollstats-0.3.tar`
...
### Comparing `pollstats-0.2/LICENSE` & `pollstats-0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `pollstats-0.2/PKG-INFO` & `pollstats-0.3/PKG-INFO`
...
### Comparing `pollstats-0.2/README.md` & `pollstats-0.3/README.md`

 * *Files identical despite different names*

### Comparing `pollstats-0.2/pollstats.egg-info/PKG-INFO` & `pollstats-0.3/pollstats.egg-info/PKG-INFO`
...
### Comparing `pollstats-0.2/pyproject.toml` & `pollstats-0.3/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pollstats-0.2/setup.py` & `pollstats-0.3/setup.py`

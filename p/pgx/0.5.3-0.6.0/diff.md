# Comparing `tmp/pgx-0.5.3.tar.gz` & `tmp/pgx-0.6.0.tar.gz`
...
### Comparing `pgx-0.5.3/pgx/_src/dwg/images/sparrow_mahjong/2p.svg` & `pgx-0.6.0/pgx/_src/dwg/images/sparrow_mahjong/2p.svg`
...
### Comparing `pgx-0.5.3/pgx/_src/struct.py` & `pgx-0.6.0/pgx/_src/struct.py`
...
### Comparing `pgx-0.5.3/pgx/bridge_bidding.py` & `pgx-0.6.0/pgx/bridge_bidding.py`
...
### Comparing `pgx-0.5.3/pgx/hex.py` & `pgx-0.6.0/pgx/hex.py`
...
### Comparing `pgx-0.5.3/pgx/minatar/freeway.py` & `pgx-0.6.0/pgx/minatar/freeway.py`
...
### Comparing `pgx-0.5.3/pgx/minatar/seaquest.py` & `pgx-0.6.0/pgx/minatar/seaquest.py`
...
### Comparing `pgx-0.5.3/pgx/minatar/space_invaders.py` & `pgx-0.6.0/pgx/minatar/space_invaders.py`
...
### Comparing `pgx-0.5.3/pgx/minatar/utils.py` & `pgx-0.6.0/pgx/minatar/utils.py`

 * *Files identical despite different names*

### Comparing `pgx-0.5.3/pgx/othello.py` & `pgx-0.6.0/pgx/othello.py`
...
### Comparing `pgx-0.5.3/pgx/play2048.py` & `pgx-0.6.0/pgx/play2048.py`
...
### Comparing `pgx-0.5.3/pgx/shogi.py` & `pgx-0.6.0/pgx/shogi.py`
...
### Comparing `pgx-0.5.3/pgx/sparrow_mahjong.py` & `pgx-0.6.0/pgx/sparrow_mahjong.py`
...
### Comparing `pgx-0.5.3/pgx/tic_tac_toe.py` & `pgx-0.6.0/pgx/tic_tac_toe.py`
...
### Comparing `pgx-0.5.3/pgx.egg-info/PKG-INFO` & `pgx-0.6.0/pgx.egg-info/PKG-INFO`
...
### Comparing `pgx-0.5.3/pgx.egg-info/SOURCES.txt` & `pgx-0.6.0/pgx.egg-info/SOURCES.txt`
...
### Comparing `pgx-0.5.3/setup.py` & `pgx-0.6.0/setup.py`
...
### Comparing `pgx-0.5.3/tests/minatar_utils.py` & `pgx-0.6.0/tests/minatar_utils.py`

 * *Files identical despite different names*

### Comparing `pgx-0.5.3/tests/test_animal_shogi.py` & `pgx-0.6.0/tests/test_animal_shogi.py`
...
### Comparing `pgx-0.5.3/tests/test_asterix.py` & `pgx-0.6.0/tests/test_asterix.py`
...
### Comparing `pgx-0.5.3/tests/test_backgammon.py` & `pgx-0.6.0/tests/test_backgammon.py`
...
### Comparing `pgx-0.5.3/tests/test_breakout.py` & `pgx-0.6.0/tests/test_breakout.py`
...
### Comparing `pgx-0.5.3/tests/test_bridge_bidding.py` & `pgx-0.6.0/tests/test_bridge_bidding.py`
...
### Comparing `pgx-0.5.3/tests/test_chess.py` & `pgx-0.6.0/tests/test_chess.py`
...
### Comparing `pgx-0.5.3/tests/test_connect_four.py` & `pgx-0.6.0/tests/test_connect_four.py`
...
### Comparing `pgx-0.5.3/tests/test_freeway.py` & `pgx-0.6.0/tests/test_freeway.py`
...
### Comparing `pgx-0.5.3/tests/test_go.py` & `pgx-0.6.0/tests/test_go.py`
...
### Comparing `pgx-0.5.3/tests/test_hex.py` & `pgx-0.6.0/tests/test_hex.py`
...
### Comparing `pgx-0.5.3/tests/test_kuhn_poker.py` & `pgx-0.6.0/tests/test_kuhn_poker.py`
...
### Comparing `pgx-0.5.3/tests/test_leduc_holdem.py` & `pgx-0.6.0/tests/test_leduc_holdem.py`
...
### Comparing `pgx-0.5.3/tests/test_mahjong.py` & `pgx-0.6.0/tests/test_mahjong.py`

 * *Files identical despite different names*

### Comparing `pgx-0.5.3/tests/test_othello.py` & `pgx-0.6.0/tests/test_othello.py`
...
### Comparing `pgx-0.5.3/tests/test_play2048.py` & `pgx-0.6.0/tests/test_play2048.py`
...
### Comparing `pgx-0.5.3/tests/test_seaquest.py` & `pgx-0.6.0/tests/test_seaquest.py`
...
### Comparing `pgx-0.5.3/tests/test_shogi.py` & `pgx-0.6.0/tests/test_shogi.py`
...
### Comparing `pgx-0.5.3/tests/test_space_invaders.py` & `pgx-0.6.0/tests/test_space_invaders.py`
...
### Comparing `pgx-0.5.3/tests/test_sparrow_mahjong.py` & `pgx-0.6.0/tests/test_sparrow_mahjong.py`
...
### Comparing `pgx-0.5.3/tests/test_tic_tac_toe.py` & `pgx-0.6.0/tests/test_tic_tac_toe.py`

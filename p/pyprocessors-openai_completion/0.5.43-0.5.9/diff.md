# Comparing `tmp/pyprocessors-openai_completion-0.5.43.tar.gz` & `tmp/pyprocessors-openai_completion-0.5.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyprocessors-openai_completion-0.5.43.tar", last modified: Thu Apr 27 11:17:30 2023, max compression
+gzip compressed data, was "pyprocessors-openai_completion-0.5.9.tar", last modified: Wed Feb 15 16:28:15 2023, max compression
```

## Comparing `pyprocessors-openai_completion-0.5.43.tar` & `pyprocessors-openai_completion-0.5.9.tar`

### file list

```diff
@@ -1,32 +1,14 @@
--rw-r--r--   0        0        0       97 2023-02-15 15:56:35.737007 pyprocessors-openai_completion-0.5.43/.dockerignore
--rw-r--r--   0        0        0      147 2023-02-15 15:56:35.738007 pyprocessors-openai_completion-0.5.43/.gitignore
--rw-r--r--   0        0        0      448 2023-02-15 15:56:35.739007 pyprocessors-openai_completion-0.5.43/Dockerfile
--rw-r--r--   0        0        0    10227 2023-02-15 16:21:10.683489 pyprocessors-openai_completion-0.5.43/Jenkinsfile
--rw-r--r--   0        0        0      380 2023-02-15 15:56:35.741007 pyprocessors-openai_completion-0.5.43/README.md
--rw-r--r--   0        0        0     1559 2023-02-15 15:56:35.742007 pyprocessors-openai_completion-0.5.43/bumpversion.py
--rw-r--r--   0        0        0       56 2023-04-27 11:17:29.313796 pyprocessors-openai_completion-0.5.43/pyprocessors_openai_completion/__init__.py
--rw-r--r--   0        0        0    10441 2023-04-27 11:13:45.720917 pyprocessors-openai_completion-0.5.43/pyprocessors_openai_completion/openai_completion.py
--rw-r--r--   0        0        0     2578 2023-04-26 13:54:40.333440 pyprocessors-openai_completion-0.5.43/pyproject.toml
--rw-r--r--   0        0        0        0 2023-02-15 15:56:35.745007 pyprocessors-openai_completion-0.5.43/tests/__init__.py
--rw-r--r--   0        0        0      674 2023-02-16 09:21:59.135153 pyprocessors-openai_completion-0.5.43/tests/data/complexdoc.json
--rw-r--r--   0        0        0     3992 2023-03-24 08:08:55.391172 pyprocessors-openai_completion-0.5.43/tests/data/en_davinci-instruct-beta.json
--rw-r--r--   0        0        0     4868 2023-03-24 08:08:55.391172 pyprocessors-openai_completion-0.5.43/tests/data/en_gpt-3.5-turbo.json
--rw-r--r--   0        0        0     4716 2023-03-24 08:08:55.391172 pyprocessors-openai_completion-0.5.43/tests/data/en_gpt-4.json
--rw-r--r--   0        0        0     4141 2023-03-24 08:08:55.392172 pyprocessors-openai_completion-0.5.43/tests/data/en_text-ada-001.json
--rw-r--r--   0        0        0     3914 2023-03-24 08:08:55.392172 pyprocessors-openai_completion-0.5.43/tests/data/en_text-babbage-001.json
--rw-r--r--   0        0        0     4187 2023-03-24 08:08:55.392172 pyprocessors-openai_completion-0.5.43/tests/data/en_text-curie-001.json
--rw-r--r--   0        0        0     4182 2023-03-24 08:08:55.392172 pyprocessors-openai_completion-0.5.43/tests/data/en_text-davinci-003.json
--rw-r--r--   0        0        0     2202 2023-03-24 08:08:55.392172 pyprocessors-openai_completion-0.5.43/tests/data/fr_davinci-instruct-beta.json
--rw-r--r--   0        0        0     3207 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_gpt-3.5-turbo.json
--rw-r--r--   0        0        0     2560 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_gpt-4.json
--rw-r--r--   0        0        0     2295 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_text-ada-001.json
--rw-r--r--   0        0        0     1699 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_text-babbage-001.json
--rw-r--r--   0        0        0     1823 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_text-curie-001.json
--rw-r--r--   0        0        0     2366 2023-03-24 08:08:55.393172 pyprocessors-openai_completion-0.5.43/tests/data/fr_text-davinci-003.json
--rw-r--r--   0        0        0     5047 2023-04-26 13:54:40.334440 pyprocessors-openai_completion-0.5.43/tests/data/jinjadocs.json
--rw-r--r--   0        0        0     6757 2023-04-27 09:54:41.705805 pyprocessors-openai_completion-0.5.43/tests/data/jinjadocs_preserve_entities.json
--rw-r--r--   0        0        0     6713 2023-04-27 09:54:41.706806 pyprocessors-openai_completion-0.5.43/tests/data/jinjadocs_substitute_entities.json
--rw-r--r--   0        0        0     8052 2023-04-27 09:54:41.707805 pyprocessors-openai_completion-0.5.43/tests/test_openai_completion.py
--rw-r--r--   0        0        0      951 2023-02-15 16:25:55.699911 pyprocessors-openai_completion-0.5.43/tox.ini
--rw-r--r--   0        0        0     1328 1970-01-01 00:00:00.000000 pyprocessors-openai_completion-0.5.43/setup.py
--rw-r--r--   0        0        0     2505 1970-01-01 00:00:00.000000 pyprocessors-openai_completion-0.5.43/PKG-INFO
...
### Comparing `pyprocessors-openai_completion-0.5.43/Jenkinsfile` & `pyprocessors-openai_completion-0.5.9/Jenkinsfile`

 * *Files identical despite different names*

### Comparing `pyprocessors-openai_completion-0.5.43/bumpversion.py` & `pyprocessors-openai_completion-0.5.9/bumpversion.py`

 * *Files identical despite different names*

### Comparing `pyprocessors-openai_completion-0.5.43/pyprocessors_openai_completion/openai_completion.py` & `pyprocessors-openai_completion-0.5.9/pyprocessors_openai_completion/openai_completion.py`
...
### Comparing `pyprocessors-openai_completion-0.5.43/pyproject.toml` & `pyprocessors-openai_completion-0.5.9/pyproject.toml`
...
### Comparing `pyprocessors-openai_completion-0.5.43/tox.ini` & `pyprocessors-openai_completion-0.5.9/tox.ini`

 * *Files identical despite different names*

### Comparing `pyprocessors-openai_completion-0.5.43/setup.py` & `pyprocessors-openai_completion-0.5.9/setup.py`
...
### Comparing `pyprocessors-openai_completion-0.5.43/PKG-INFO` & `pyprocessors-openai_completion-0.5.9/PKG-INFO`

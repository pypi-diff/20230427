# Comparing `tmp/tailwind_colors-1.0.1.tar.gz` & `tmp/tailwind_colors-1.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tailwind_colors-1.0.1.tar", max compression
+gzip compressed data, was "tailwind_colors-1.1.0.tar", max compression
```

## Comparing `tailwind_colors-1.0.1.tar` & `tailwind_colors-1.1.0.tar`

### file list

```diff
@@ -1,6 +1,7 @@
--rw-r--r--   0        0        0     1072 2023-02-21 00:28:57.501512 tailwind_colors-1.0.1/LICENSE.md
--rw-r--r--   0        0        0      414 2023-02-21 00:07:07.496678 tailwind_colors-1.0.1/README.md
--rw-r--r--   0        0        0     1140 2023-04-27 13:59:15.483051 tailwind_colors-1.0.1/pyproject.toml
--rw-r--r--   0        0        0    10368 2023-04-27 13:58:55.650437 tailwind_colors-1.0.1/tailwind_colors/__init__.py
--rw-r--r--   0        0        0     1173 1970-01-01 00:00:00.000000 tailwind_colors-1.0.1/setup.py
--rw-r--r--   0        0        0     1697 1970-01-01 00:00:00.000000 tailwind_colors-1.0.1/PKG-INFO
+-rw-r--r--   0        0        0     1072 2023-02-21 00:28:57.501512 tailwind_colors-1.1.0/LICENSE.md
+-rw-r--r--   0        0        0      414 2023-02-21 00:07:07.496678 tailwind_colors-1.1.0/README.md
+-rw-r--r--   0        0        0     1140 2023-04-27 14:07:21.152653 tailwind_colors-1.1.0/pyproject.toml
+-rw-r--r--   0        0        0    11380 2023-04-27 14:07:03.749196 tailwind_colors-1.1.0/tailwind_colors/__init__.py
+-rw-r--r--   0        0        0        0 2023-04-27 14:01:08.435762 tailwind_colors-1.1.0/tailwind_colors/py.typed
+-rw-r--r--   0        0        0     1173 1970-01-01 00:00:00.000000 tailwind_colors-1.1.0/setup.py
+-rw-r--r--   0        0        0     1697 1970-01-01 00:00:00.000000 tailwind_colors-1.1.0/PKG-INFO
```

### Comparing `tailwind_colors-1.0.1/LICENSE.md` & `tailwind_colors-1.1.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `tailwind_colors-1.0.1/pyproject.toml` & `tailwind_colors-1.1.0/pyproject.toml`
...
### Comparing `tailwind_colors-1.0.1/tailwind_colors/__init__.py` & `tailwind_colors-1.1.0/tailwind_colors/__init__.py`
...
### Comparing `tailwind_colors-1.0.1/setup.py` & `tailwind_colors-1.1.0/setup.py`
...
### Comparing `tailwind_colors-1.0.1/PKG-INFO` & `tailwind_colors-1.1.0/PKG-INFO`

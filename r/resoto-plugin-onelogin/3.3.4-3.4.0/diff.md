# Comparing `tmp/resoto-plugin-onelogin-3.3.4.tar.gz` & `tmp/resoto-plugin-onelogin-3.4.0.tar.gz`
...
## Comparing `resoto-plugin-onelogin-3.3.4.tar` & `resoto-plugin-onelogin-3.4.0.tar`
...
### Comparing `resoto-plugin-onelogin-3.3.4/PKG-INFO` & `resoto-plugin-onelogin-3.4.0/PKG-INFO`
...
### Comparing `resoto-plugin-onelogin-3.3.4/resoto_plugin_onelogin/__init__.py` & `resoto-plugin-onelogin-3.4.0/resoto_plugin_onelogin/__init__.py`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onelogin-3.3.4/resoto_plugin_onelogin.egg-info/PKG-INFO` & `resoto-plugin-onelogin-3.4.0/resoto_plugin_onelogin.egg-info/PKG-INFO`
...
### Comparing `resoto-plugin-onelogin-3.3.4/setup.py` & `resoto-plugin-onelogin-3.4.0/setup.py`

# Comparing `tmp/bacteria-0.1.6.tar.gz` & `tmp/bacteria-0.1.7.tar.gz`
...
## Comparing `bacteria-0.1.6.tar` & `bacteria-0.1.7.tar`
...
### Comparing `bacteria-0.1.6/PKG-INFO` & `bacteria-0.1.7/PKG-INFO`
...
### Comparing `bacteria-0.1.6/bacteria/functions.py` & `bacteria-0.1.7/bacteria/functions.py`
...
### Comparing `bacteria-0.1.6/bacteria.egg-info/PKG-INFO` & `bacteria-0.1.7/bacteria.egg-info/PKG-INFO`
...
### Comparing `bacteria-0.1.6/setup.py` & `bacteria-0.1.7/setup.py`

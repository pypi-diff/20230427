# Comparing `tmp/dagster-mlflow-0.19.2.tar.gz` & `tmp/dagster-mlflow-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dagster-mlflow-0.19.2.tar", last modified: Thu Apr 27 19:41:12 2023, max compression
+gzip compressed data, was "dagster-mlflow-1.0.5.tar", last modified: Fri Aug 26 13:47:04 2022, max compression
```

## Comparing `dagster-mlflow-0.19.2.tar` & `dagster-mlflow-1.0.5.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-27 19:41:12.237668 dagster-mlflow-0.19.2/
--rw-r--r--   0 root         (0) root         (0)    11344 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/LICENSE
--rw-r--r--   0 root         (0) root         (0)       66 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/MANIFEST.in
--rw-r--r--   0 root         (0) root         (0)      621 2023-04-27 19:41:12.237668 dagster-mlflow-0.19.2/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      128 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-27 19:41:12.237668 dagster-mlflow-0.19.2/dagster_mlflow/
--rw-r--r--   0 root         (0) root         (0)      303 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/dagster_mlflow/__init__.py
--rw-r--r--   0 root         (0) root         (0)     1232 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/dagster_mlflow/hooks.py
--rw-r--r--   0 root         (0) root         (0)        8 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/dagster_mlflow/py.typed
--rw-r--r--   0 root         (0) root         (0)    10816 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/dagster_mlflow/resources.py
--rw-r--r--   0 root         (0) root         (0)       23 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/dagster_mlflow/version.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-27 19:41:12.237668 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/
--rw-r--r--   0 root         (0) root         (0)      621 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      403 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/not-zip-safe
--rw-r--r--   0 root         (0) root         (0)       22 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       15 2023-04-27 19:41:11.000000 dagster-mlflow-0.19.2/dagster_mlflow.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)      161 2023-04-27 19:41:12.241668 dagster-mlflow-0.19.2/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     1103 2023-04-27 18:30:35.000000 dagster-mlflow-0.19.2/setup.py
...
### Comparing `dagster-mlflow-0.19.2/LICENSE` & `dagster-mlflow-1.0.5/LICENSE`
...
### Comparing `dagster-mlflow-0.19.2/dagster_mlflow/hooks.py` & `dagster-mlflow-1.0.5/dagster_mlflow/hooks.py`
...
### Comparing `dagster-mlflow-0.19.2/dagster_mlflow/resources.py` & `dagster-mlflow-1.0.5/dagster_mlflow/resources.py`
...
### Comparing `dagster-mlflow-0.19.2/setup.py` & `dagster-mlflow-1.0.5/setup.py`

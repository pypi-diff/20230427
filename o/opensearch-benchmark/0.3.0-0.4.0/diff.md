# Comparing `tmp/opensearch-benchmark-0.3.0.tar.gz` & `tmp/opensearch-benchmark-0.4.0.tar.gz`
...
### Comparing `opensearch-benchmark-0.3.0/AUTHORS` & `opensearch-benchmark-0.4.0/AUTHORS`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/CONTRIBUTING.md` & `opensearch-benchmark-0.4.0/CONTRIBUTING.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/LICENSE` & `opensearch-benchmark-0.4.0/LICENSE`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/PKG-INFO` & `opensearch-benchmark-0.4.0/PKG-INFO`
...
### Comparing `opensearch-benchmark-0.3.0/README.md` & `opensearch-benchmark-0.4.0/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/docs/api/execute-test.md` & `opensearch-benchmark-0.4.0/docs/api/execute-test.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/docs/user-guides/create-pipeline.md` & `opensearch-benchmark-0.4.0/docs/user-guides/create-pipeline.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/opensearch_benchmark.egg-info/PKG-INFO` & `opensearch-benchmark-0.4.0/opensearch_benchmark.egg-info/PKG-INFO`
...
### Comparing `opensearch-benchmark-0.3.0/opensearch_benchmark.egg-info/SOURCES.txt` & `opensearch-benchmark-0.4.0/opensearch_benchmark.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/__init__.py`
...
### Comparing `opensearch-benchmark-0.3.0/osbenchmark/actor.py` & `opensearch-benchmark-0.4.0/osbenchmark/actor.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/async_connection.py` & `opensearch-benchmark-0.4.0/osbenchmark/async_connection.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/benchmark.py` & `opensearch-benchmark-0.4.0/osbenchmark/benchmark.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/benchmarkd.py` & `opensearch-benchmark-0.4.0/osbenchmark/benchmarkd.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/__init__.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/builder.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/builder.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/cluster.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/cluster.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/cluster_builder.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/cluster_builder.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/configs/listers/plugin_config_instance_lister.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/configs/listers/plugin_config_instance_lister.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/configs/utils/config_path_resolver.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/configs/utils/config_path_resolver.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/builders/binary_builder.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/builders/binary_builder.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/builders/source_binary_builder.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/builders/source_binary_builder.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/core_plugin_source_downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/core_plugin_source_downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/external_plugin_source_downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/external_plugin_source_downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/opensearch_distribution_downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/opensearch_distribution_downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/opensearch_source_downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/opensearch_source_downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/plugin_distribution_downloader.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/plugin_distribution_downloader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/repositories/opensearch_distribution_repository_provider.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/repositories/opensearch_distribution_repository_provider.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/repositories/plugin_distribution_repository_provider.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/repositories/plugin_distribution_repository_provider.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/repositories/repository_url_provider.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/repositories/repository_url_provider.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/downloaders/repositories/source_repository_provider.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/downloaders/repositories/source_repository_provider.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/executors/local_shell_executor.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/executors/local_shell_executor.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/executors/shell_executor.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/executors/shell_executor.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/bare_installer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/bare_installer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/docker_installer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/docker_installer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/exception_handling_installer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/exception_handling_installer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/installer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/installer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/preparers/opensearch_preparer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/preparers/opensearch_preparer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/preparers/plugin_preparer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/preparers/plugin_preparer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/installers/preparers/preparer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/installers/preparers/preparer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/java_resolver.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/java_resolver.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/launcher.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/launcher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/launchers/docker_launcher.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/launchers/docker_launcher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/launchers/exception_handling_launcher.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/launchers/exception_handling_launcher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/launchers/launcher.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/launchers/launcher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/launchers/local_process_launcher.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/launchers/local_process_launcher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/models/architecture_types.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/models/architecture_types.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/models/config_instance_types.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/models/config_instance_types.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/models/plugin_config_instance.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/models/plugin_config_instance.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/models/provision_config_instance.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/models/provision_config_instance.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/models/provision_config_instance_descriptor.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/models/provision_config_instance_descriptor.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/provision_config.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/provision_config.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/provisioner.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/provisioner.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/provisioners/provisioner.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/provisioners/provisioner.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/supplier.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/supplier.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/artifact_variables_provider.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/artifact_variables_provider.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/config_applier.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/config_applier.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/git_manager.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/git_manager.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/host_cleaner.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/host_cleaner.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/java_home_resolver.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/java_home_resolver.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/jdk_resolver.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/jdk_resolver.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/path_manager.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/path_manager.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/builder/utils/template_renderer.py` & `opensearch-benchmark-0.4.0/osbenchmark/builder/utils/template_renderer.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/chart_generator.py` & `opensearch-benchmark-0.4.0/osbenchmark/chart_generator.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/client.py` & `opensearch-benchmark-0.4.0/osbenchmark/client.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/config.py` & `opensearch-benchmark-0.4.0/osbenchmark/config.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/exceptions.py` & `opensearch-benchmark-0.4.0/osbenchmark/exceptions.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/log.py` & `opensearch-benchmark-0.4.0/osbenchmark/log.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/metrics.py` & `opensearch-benchmark-0.4.0/osbenchmark/metrics.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/paths.py` & `opensearch-benchmark-0.4.0/osbenchmark/paths.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/benchmark.ini` & `opensearch-benchmark-0.4.0/osbenchmark/resources/benchmark.ini`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/docker-compose.yml.j2` & `opensearch-benchmark-0.4.0/osbenchmark/resources/docker-compose.yml.j2`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/logging.json` & `opensearch-benchmark-0.4.0/osbenchmark/resources/logging.json`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/metrics-template.json` & `opensearch-benchmark-0.4.0/osbenchmark/resources/metrics-template.json`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/core-plugins.txt` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/core-plugins.txt`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_azure/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_azure/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_azure/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_azure/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_gcs/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_gcs/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_gcs/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_gcs/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_s3/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_s3/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_s3/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/plugins/v1/repository_s3/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/default_distro/config.ini` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/default_distro/config.ini`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/config.ini` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/config.ini`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/jvm.options` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/jvm.options`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/log4j2.properties` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/log4j2.properties`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/opensearch.yml` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/1.0/provision_config_instances/v1/vanilla/templates/config/opensearch.yml`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/core-plugins.txt` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/core-plugins.txt`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_azure/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_azure/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_azure/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_azure/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_gcs/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_gcs/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_gcs/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_gcs/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_s3/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_s3/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_s3/plugin.py` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/plugins/v1/repository_s3/plugin.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/README.md` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/README.md`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/config.ini` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/config.ini`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/jvm.options` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/jvm.options`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/log4j2.properties` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/log4j2.properties`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/opensearch.yml` & `opensearch-benchmark-0.4.0/osbenchmark/resources/provision_configs/main/provision_config_instances/v1/vanilla/templates/config/opensearch.yml`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/results-template.json` & `opensearch-benchmark-0.4.0/osbenchmark/resources/results-template.json`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/test-executions-template.json` & `opensearch-benchmark-0.4.0/osbenchmark/resources/test-executions-template.json`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/workload-schema.json` & `opensearch-benchmark-0.4.0/osbenchmark/resources/workload-schema.json`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/resources/workload.json.j2` & `opensearch-benchmark-0.4.0/osbenchmark/resources/workload.json.j2`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/results_publisher.py` & `opensearch-benchmark-0.4.0/osbenchmark/results_publisher.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/telemetry.py` & `opensearch-benchmark-0.4.0/osbenchmark/telemetry.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/test_execution_orchestrator.py` & `opensearch-benchmark-0.4.0/osbenchmark/test_execution_orchestrator.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/time.py` & `opensearch-benchmark-0.4.0/osbenchmark/time.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/collections.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/collections.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/console.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/console.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/convert.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/convert.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/git.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/git.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/io.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/io.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/jvm.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/jvm.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/modules.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/modules.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/net.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/net.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/opts.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/opts.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/periodic_waiter.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/periodic_waiter.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/process.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/process.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/repo.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/repo.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/sysstats.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/sysstats.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/utils/versions.py` & `opensearch-benchmark-0.4.0/osbenchmark/utils/versions.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/version.py` & `opensearch-benchmark-0.4.0/osbenchmark/version.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/worker_coordinator/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/worker_coordinator/__init__.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/worker_coordinator/runner.py` & `opensearch-benchmark-0.4.0/osbenchmark/worker_coordinator/runner.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/worker_coordinator/scheduler.py` & `opensearch-benchmark-0.4.0/osbenchmark/worker_coordinator/scheduler.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/worker_coordinator/worker_coordinator.py` & `opensearch-benchmark-0.4.0/osbenchmark/worker_coordinator/worker_coordinator.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload/__init__.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload/loader.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload/loader.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload/params.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload/params.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload/workload.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload/workload.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload_generator/__init__.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload_generator/__init__.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload_generator/corpus.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload_generator/corpus.py`
...
### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload_generator/index.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload_generator/index.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/osbenchmark/workload_generator/workload_generator.py` & `opensearch-benchmark-0.4.0/osbenchmark/workload_generator/workload_generator.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/setup.py` & `opensearch-benchmark-0.4.0/setup.py`
...
### Comparing `opensearch-benchmark-0.3.0/tests/test_async_connection.py` & `opensearch-benchmark-0.4.0/tests/test_async_connection.py`

 * *Files identical despite different names*

### Comparing `opensearch-benchmark-0.3.0/tests/test_execution_orchestrator_test.py` & `opensearch-benchmark-0.4.0/tests/test_execution_orchestrator_test.py`

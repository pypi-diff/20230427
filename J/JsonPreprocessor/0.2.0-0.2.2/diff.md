# Comparing `tmp/JsonPreprocessor-0.2.0.tar.gz` & `tmp/JsonPreprocessor-0.2.2.tar.gz`
...
## Comparing `JsonPreprocessor-0.2.0.tar` & `JsonPreprocessor-0.2.2.tar`
...
### Comparing `JsonPreprocessor-0.2.0/JsonPreprocessor/__init__.py` & `JsonPreprocessor-0.2.2/JsonPreprocessor/__init__.py`
...
### Comparing `JsonPreprocessor-0.2.0/LICENSE` & `JsonPreprocessor-0.2.2/LICENSE`

 * *Files identical despite different names*

### Comparing `JsonPreprocessor-0.2.0/README.rst` & `JsonPreprocessor-0.2.2/README.rst`
...
### Comparing `JsonPreprocessor-0.2.0/setup.py` & `JsonPreprocessor-0.2.2/setup.py`

# Comparing `tmp/mb_pytorch-1.0.202304262230-py3-none-any.whl.zip` & `tmp/mb_pytorch-1.0.202304262233-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,20 +1,20 @@
-Zip file size: 38096 bytes, number of entries: 39
...
--rw-rw-r--  2.0 unx     3601 b- defN 23-Apr-26 22:30 mb_pytorch/models/modelloader.py
...
--rwxrwxr-x  2.0 unx     1304 b- defN 23-Apr-26 22:31 mb_pytorch-1.0.202304262230.data/scripts/dataload_results.py
--rwxrwxr-x  2.0 unx      980 b- defN 23-Mar-15 02:59 mb_pytorch-1.0.202304262230.data/scripts/emb.py
--rw-rw-r--  2.0 unx      329 b- defN 23-Apr-26 22:31 mb_pytorch-1.0.202304262230.dist-info/METADATA
--rw-rw-r--  2.0 unx       92 b- defN 23-Apr-26 22:31 mb_pytorch-1.0.202304262230.dist-info/WHEEL
--rw-rw-r--  2.0 unx       11 b- defN 23-Apr-26 22:31 mb_pytorch-1.0.202304262230.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     3529 b- defN 23-Apr-26 22:31 mb_pytorch-1.0.202304262230.dist-info/RECORD
-39 files, 123786 bytes uncompressed, 32348 bytes compressed:  73.9%
...
-Filename: mb_pytorch-1.0.202304262230.data/scripts/dataload_results.py
+Filename: mb_pytorch-1.0.202304262233.data/scripts/dataload_results.py
 Comment: 
 
-Filename: mb_pytorch-1.0.202304262230.data/scripts/emb.py
+Filename: mb_pytorch-1.0.202304262233.data/scripts/emb.py
 Comment: 
 
-Filename: mb_pytorch-1.0.202304262230.dist-info/METADATA
+Filename: mb_pytorch-1.0.202304262233.dist-info/METADATA
 Comment: 
 
-Filename: mb_pytorch-1.0.202304262230.dist-info/WHEEL
+Filename: mb_pytorch-1.0.202304262233.dist-info/WHEEL
 Comment: 
 
-Filename: mb_pytorch-1.0.202304262230.dist-info/top_level.txt
+Filename: mb_pytorch-1.0.202304262233.dist-info/top_level.txt
 Comment: 
 
-Filename: mb_pytorch-1.0.202304262230.dist-info/RECORD
...
## Comparing `mb_pytorch-1.0.202304262230.data/scripts/dataload_results.py` & `mb_pytorch-1.0.202304262233.data/scripts/dataload_results.py`

 * *Files identical despite different names*

## Comparing `mb_pytorch-1.0.202304262230.data/scripts/emb.py` & `mb_pytorch-1.0.202304262233.data/scripts/emb.py`

 * *Files identical despite different names*

## Comparing `mb_pytorch-1.0.202304262230.dist-info/RECORD` & `mb_pytorch-1.0.202304262233.dist-info/RECORD`
...
-mb_pytorch/models/modelloader.py,sha256=aHfEIWkFoxbPOMcV67tcjZ72KZrpZpHoEERUQA8-j_0,3601
...
-mb_pytorch-1.0.202304262230.data/scripts/dataload_results.py,sha256=8IFAH7WX-nSJ7V532rr3Cl7R37v0jhSakw0JCd9dalE,1304
-mb_pytorch-1.0.202304262230.data/scripts/emb.py,sha256=5jSbTGNOhusDTvHZeaTwk4pmJa4HIdkRGd98s0L4Rl0,980
-mb_pytorch-1.0.202304262230.dist-info/METADATA,sha256=1MsNbC1UWRtf5VZoiAQiZkhGFFVo3QtQLAApejzBhlY,329
-mb_pytorch-1.0.202304262230.dist-info/WHEEL,sha256=g4nMs7d-Xl9-xC9XovUrsDHGXt-FT0E17Yqo92DEfvY,92
-mb_pytorch-1.0.202304262230.dist-info/top_level.txt,sha256=2m_aBiEfjq3pZM2NtYSlTqlgoQxH6WaK8_8SsRicIvg,11
-mb_pytorch-1.0.202304262230.dist-info/RECORD,,

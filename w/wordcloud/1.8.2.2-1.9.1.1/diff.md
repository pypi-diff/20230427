# Comparing `tmp/wordcloud-1.8.2.2.tar.gz` & `tmp/wordcloud-1.9.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "wordcloud-1.8.2.2.tar", last modified: Mon Jun 27 18:15:21 2022, max compression
+gzip compressed data, was "wordcloud-1.9.1.1.tar", last modified: Thu Apr 27 20:34:02 2023, max compression
```

## Comparing `wordcloud-1.8.2.2.tar` & `wordcloud-1.9.1.1.tar`

### file list

```diff
@@ -1,29 +1,29 @@
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/
--rw-r--r--   0 runner    (1001) docker     (121)     1069 2022-06-27 18:15:05.000000 wordcloud-1.8.2.2/LICENSE
--rw-r--r--   0 runner    (1001) docker     (121)       52 2022-06-27 18:15:05.000000 wordcloud-1.8.2.2/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (121)     3349 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)     3049 2022-06-27 18:15:05.000000 wordcloud-1.8.2.2/README.md
--rw-r--r--   0 runner    (1001) docker     (121)      670 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (121)      942 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-06-27 18:15:21.723841 wordcloud-1.8.2.2/test/
--rw-r--r--   0 runner    (1001) docker     (121)    15080 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/test/test_wordcloud.py
--rw-r--r--   0 runner    (1001) docker     (121)     8494 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/test/test_wordcloud_cli.py
--rw-r--r--   0 runner    (1001) docker     (121)    68612 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/versioneer.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/wordcloud/
--rw-r--r--   0 runner    (1001) docker     (121)   119380 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/DroidSansMono.ttf
--rw-r--r--   0 runner    (1001) docker     (121)      399 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)      857 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/__main__.py
--rw-r--r--   0 runner    (1001) docker     (121)      499 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/wordcloud/_version.py
--rw-r--r--   0 runner    (1001) docker     (121)     2621 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/color_from_image.py
--rw-r--r--   0 runner    (1001) docker     (121)   777709 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/query_integral_image.c
--rw-r--r--   0 runner    (1001) docker     (121)     1050 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/stopwords
--rw-r--r--   0 runner    (1001) docker     (121)     5364 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/tokenization.py
--rw-r--r--   0 runner    (1001) docker     (121)    38138 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/wordcloud.py
--rw-r--r--   0 runner    (1001) docker     (121)     9006 2022-06-27 18:15:06.000000 wordcloud-1.8.2.2/wordcloud/wordcloud_cli.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-06-27 18:15:21.727841 wordcloud-1.8.2.2/wordcloud.egg-info/
--rw-r--r--   0 runner    (1001) docker     (121)     3349 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)      565 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (121)        1 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (121)       58 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (121)       31 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (121)       10 2022-06-27 18:15:21.000000 wordcloud-1.8.2.2/wordcloud.egg-info/top_level.txt
...
### Comparing `wordcloud-1.8.2.2/LICENSE` & `wordcloud-1.9.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/PKG-INFO` & `wordcloud-1.9.1.1/PKG-INFO`
...
### Comparing `wordcloud-1.8.2.2/README.md` & `wordcloud-1.9.1.1/wordcloud.egg-info/PKG-INFO`
...
### Comparing `wordcloud-1.8.2.2/setup.cfg` & `wordcloud-1.9.1.1/setup.cfg`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/setup.py` & `wordcloud-1.9.1.1/setup.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/test/test_wordcloud.py` & `wordcloud-1.9.1.1/test/test_wordcloud.py`
...
### Comparing `wordcloud-1.8.2.2/test/test_wordcloud_cli.py` & `wordcloud-1.9.1.1/test/test_wordcloud_cli.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/versioneer.py` & `wordcloud-1.9.1.1/versioneer.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud/DroidSansMono.ttf` & `wordcloud-1.9.1.1/wordcloud/DroidSansMono.ttf`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud/__main__.py` & `wordcloud-1.9.1.1/wordcloud/__main__.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud/color_from_image.py` & `wordcloud-1.9.1.1/wordcloud/color_from_image.py`
...
### Comparing `wordcloud-1.8.2.2/wordcloud/query_integral_image.c` & `wordcloud-1.9.1.1/wordcloud/query_integral_image.c`
...
+static const char __pyx_k_wordcloud_query_integral_image_p[] = "wordcloud/query_integral_image.pyx";
...
+static PyObject *__pyx_kp_s_wordcloud_query_integral_image_p;
...
+  {&__pyx_kp_s_wordcloud_query_integral_image_p, __pyx_k_wordcloud_query_integral_image_p, sizeof(__pyx_k_wordcloud_query_integral_image_p), 0, 0, 1, 0},
...
+  __pyx_tuple__20 = PyTuple_Pack(11, __pyx_n_s_integral_image, __pyx_n_s_size_x, __pyx_n_s_size_y, __pyx_n_s_random_state, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_area, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_hits, __pyx_n_s_goal); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
+  __Pyx_GOTREF(__pyx_tuple__20);
+  __Pyx_GIVEREF(__pyx_tuple__20);
+  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(4, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_wordcloud_query_integral_image_p, __pyx_n_s_query_integral_image, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
...
### Comparing `wordcloud-1.8.2.2/wordcloud/stopwords` & `wordcloud-1.9.1.1/wordcloud/stopwords`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud/tokenization.py` & `wordcloud-1.9.1.1/wordcloud/tokenization.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud/wordcloud.py` & `wordcloud-1.9.1.1/wordcloud/wordcloud.py`
...
### Comparing `wordcloud-1.8.2.2/wordcloud/wordcloud_cli.py` & `wordcloud-1.9.1.1/wordcloud/wordcloud_cli.py`

 * *Files identical despite different names*

### Comparing `wordcloud-1.8.2.2/wordcloud.egg-info/PKG-INFO` & `wordcloud-1.9.1.1/README.md`
...
### Comparing `wordcloud-1.8.2.2/wordcloud.egg-info/SOURCES.txt` & `wordcloud-1.9.1.1/wordcloud.egg-info/SOURCES.txt`

# Comparing `tmp/acdcserver-2.2.0rc9.tar.gz` & `tmp/acdcserver-2.2.1rc1.tar.gz`
...
### Comparing `acdcserver-2.2.0rc9/LICENSE` & `acdcserver-2.2.1rc1/LICENSE`
...
### Comparing `acdcserver-2.2.0rc9/bin/check-request-wq-status` & `acdcserver-2.2.1rc1/bin/check-request-wq-status`
...
### Comparing `acdcserver-2.2.0rc9/bin/kill-workflow-in-agent` & `acdcserver-2.2.1rc1/bin/kill-workflow-in-agent`
...
### Comparing `acdcserver-2.2.0rc9/bin/patchComponent.sh` & `acdcserver-2.2.1rc1/bin/patchComponent.sh`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/paused-jobs` & `acdcserver-2.2.1rc1/bin/paused-jobs`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/purgeDeletedCouchDoc.py` & `acdcserver-2.2.1rc1/bin/purgeDeletedCouchDoc.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/reqmgr-put-default-config` & `acdcserver-2.2.1rc1/bin/reqmgr-put-default-config`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/reqmgr-sw-update` & `acdcserver-2.2.1rc1/bin/reqmgr-sw-update`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/vaildateCMSSWMergeVersion` & `acdcserver-2.2.1rc1/bin/vaildateCMSSWMergeVersion`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-couchapp-init` & `acdcserver-2.2.1rc1/bin/wmagent-couchapp-init`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-delete-couchdb-workflow` & `acdcserver-2.2.1rc1/bin/wmagent-delete-couchdb-workflow`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-mod-config` & `acdcserver-2.2.1rc1/bin/wmagent-mod-config`
...
### Comparing `acdcserver-2.2.0rc9/bin/wmagent-resource-control` & `acdcserver-2.2.1rc1/bin/wmagent-resource-control`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-unregister-wmstats` & `acdcserver-2.2.1rc1/bin/wmagent-unregister-wmstats`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-upload-config` & `acdcserver-2.2.1rc1/bin/wmagent-upload-config`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmagent-workqueue` & `acdcserver-2.2.1rc1/bin/wmagent-workqueue`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmc-dist-patch` & `acdcserver-2.2.1rc1/bin/wmc-dist-patch`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmcore-db-init` & `acdcserver-2.2.1rc1/bin/wmcore-db-init`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmcore-new-config` & `acdcserver-2.2.1rc1/bin/wmcore-new-config`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmcore-new-flow` & `acdcserver-2.2.1rc1/bin/wmcore-new-flow`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/bin/wmcoreD` & `acdcserver-2.2.1rc1/bin/wmcoreD`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/setup.py` & `acdcserver-2.2.1rc1/setup.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/setup_build.py` & `acdcserver-2.2.1rc1/setup_build.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/setup_dependencies.py` & `acdcserver-2.2.1rc1/setup_dependencies.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/_attachments/CouchDBLogo.png` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/_attachments/CouchDBLogo.png`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/_attachments/DMWMLogo.png` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/_attachments/DMWMLogo.png`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/_attachments/collections.html` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/_attachments/collections.html`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/_attachments/displaycollection.html` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/_attachments/displaycollection.html`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/_attachments/index.html` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/_attachments/index.html`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/rewrites.json` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/rewrites.json`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/ACDC/vendor/acdc/_attachments/acdc.js` & `acdcserver-2.2.1rc1/src/couchapps/ACDC/vendor/acdc/_attachments/acdc.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/_attachments/index.html` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/_attachments/index.html`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/vendor/couchapp/_attachments/jquery.couchapp.js` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/vendor/couchapp/_attachments/jquery.couchapp.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/vendor/couchapp/date.js` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/vendor/couchapp/date.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/vendor/couchapp/path.js` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/vendor/couchapp/path.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/vendor/couchapp/template.js` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/vendor/couchapp/template.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/couchapps/GroupUser/vendor/groupuser/_attachments/groupuser.js` & `acdcserver-2.2.1rc1/src/couchapps/GroupUser/vendor/groupuser/_attachments/groupuser.js`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/Collection.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/Collection.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/CouchCollection.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/CouchCollection.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/CouchFileset.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/CouchFileset.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/CouchService.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/CouchService.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/DataCollectionService.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/DataCollectionService.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/ACDC/Fileset.py` & `acdcserver-2.2.1rc1/src/python/WMCore/ACDC/Fileset.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Algorithms/ParseXMLFile.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Algorithms/ParseXMLFile.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Algorithms/Permissions.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Algorithms/Permissions.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Configuration.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Configuration.py`
...
### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/File.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/File.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Fileset.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Fileset.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Job.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Job.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/JobGroup.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/JobGroup.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/JobPackage.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/JobPackage.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/LumiList.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/LumiList.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Mask.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Mask.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Run.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Run.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Subscription.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Subscription.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/WMObject.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/WMObject.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/WorkUnit.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/WorkUnit.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/DataStructs/Workflow.py` & `acdcserver-2.2.1rc1/src/python/WMCore/DataStructs/Workflow.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/CMSCouch.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/CMSCouch.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/ConfigDBMap.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/ConfigDBMap.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/CouchUtils.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/CouchUtils.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/DBCore.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/DBCore.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/DBCreator.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/DBCreator.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/DBExceptionHandler.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/DBExceptionHandler.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/DBFactory.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/DBFactory.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/DBFormatter.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/DBFormatter.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/ExecuteDAO.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/ExecuteDAO.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/MongoDB.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/MongoDB.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/MySQLCore.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/MySQLCore.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/ResultSet.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/ResultSet.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/Transaction.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/Transaction.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Database/ipy_profile_couch.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Database/ipy_profile_couch.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/GroupUser/CouchObject.py` & `acdcserver-2.2.1rc1/src/python/WMCore/GroupUser/CouchObject.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/GroupUser/Decorators.py` & `acdcserver-2.2.1rc1/src/python/WMCore/GroupUser/Decorators.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/GroupUser/Group.py` & `acdcserver-2.2.1rc1/src/python/WMCore/GroupUser/Group.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/GroupUser/Interface.py` & `acdcserver-2.2.1rc1/src/python/WMCore/GroupUser/Interface.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/GroupUser/User.py` & `acdcserver-2.2.1rc1/src/python/WMCore/GroupUser/User.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Lexicon.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Lexicon.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Services/Requests.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Services/Requests.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Services/pycurl_manager.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Services/pycurl_manager.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/WMException.py` & `acdcserver-2.2.1rc1/src/python/WMCore/WMException.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/WMCore/Wrappers/JsonWrapper/JSONThunker.py` & `acdcserver-2.2.1rc1/src/python/WMCore/Wrappers/JsonWrapper/JSONThunker.py`

 * *Files identical despite different names*

### Comparing `acdcserver-2.2.0rc9/src/python/acdcserver.egg-info/SOURCES.txt` & `acdcserver-2.2.1rc1/src/python/acdcserver.egg-info/SOURCES.txt`

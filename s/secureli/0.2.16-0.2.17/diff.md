# Comparing `tmp/secureli-0.2.16.tar.gz` & `tmp/secureli-0.2.17.tar.gz`
...
### Comparing `secureli-0.2.16/secureli/repositories/secureli_config.py` & `secureli-0.2.17/secureli/repositories/secureli_config.py`

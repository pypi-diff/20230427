# Comparing `tmp/lsst-rsp-0.3.3.tar.gz` & `tmp/lsst-rsp-0.3.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "lsst-rsp-0.3.3.tar", last modified: Thu Feb 16 16:25:26 2023, max compression
+gzip compressed data, was "lsst-rsp-0.3.4.tar", last modified: Thu Apr 27 21:04:46 2023, max compression
```

## Comparing `lsst-rsp-0.3.3.tar` & `lsst-rsp-0.3.4.tar`

### file list

```diff
@@ -1,46 +1,46 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/.github/
--rw-r--r--   0 runner    (1001) docker     (123)      209 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/.github/dependabot.yml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/.github/workflows/
--rw-r--r--   0 runner    (1001) docker     (123)     1975 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/.github/workflows/ci.yaml
--rw-r--r--   0 runner    (1001) docker     (123)     2024 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/.gitignore
--rw-r--r--   0 runner    (1001) docker     (123)      447 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/.pre-commit-config.yaml
--rw-r--r--   0 runner    (1001) docker     (123)     1068 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)      170 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/Makefile
--rw-r--r--   0 runner    (1001) docker     (123)     2017 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      101 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/README.rst
--rw-r--r--   0 runner    (1001) docker     (123)     1344 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)     1453 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)       58 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/jupyterlabutils/
--rw-r--r--   0 runner    (1001) docker     (123)      201 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/jupyterlabutils/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/jupyterlabutils/notebook/
--rw-r--r--   0 runner    (1001) docker     (123)      308 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/jupyterlabutils/notebook/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/lsst/
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/lsst/rsp/
--rw-r--r--   0 runner    (1001) docker     (123)      981 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/rsp/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2695 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/rsp/catalog.py
--rw-r--r--   0 runner    (1001) docker     (123)     1893 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/rsp/forwarder.py
--rw-r--r--   0 runner    (1001) docker     (123)     3366 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/rsp/log.py
--rw-r--r--   0 runner    (1001) docker     (123)     5426 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/lsst/rsp/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.421558 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2017 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      790 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)      144 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       41 2023-02-16 16:25:26.000000 lsst-rsp-0.3.3/src/lsst_rsp.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/src/rubin_jupyter_utils/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/rubin_jupyter_utils/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/
--rw-r--r--   0 runner    (1001) docker     (123)       77 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/notebook/
--rw-r--r--   0 runner    (1001) docker     (123)     1338 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/notebook/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/notebook/utils/
--rw-r--r--   0 runner    (1001) docker     (123)      153 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/notebook/utils/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-02-16 16:25:26.425558 lsst-rsp-0.3.3/tests/
--rw-r--r--   0 runner    (1001) docker     (123)      424 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/tests/utils_test.py
--rw-r--r--   0 runner    (1001) docker     (123)      646 2023-02-16 16:25:08.000000 lsst-rsp-0.3.3/tox.ini
...
### Comparing `lsst-rsp-0.3.3/.github/workflows/ci.yaml` & `lsst-rsp-0.3.4/.github/workflows/ci.yaml`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/.gitignore` & `lsst-rsp-0.3.4/.gitignore`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/LICENSE` & `lsst-rsp-0.3.4/LICENSE`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/PKG-INFO` & `lsst-rsp-0.3.4/PKG-INFO`
...
### Comparing `lsst-rsp-0.3.3/pyproject.toml` & `lsst-rsp-0.3.4/pyproject.toml`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/setup.cfg` & `lsst-rsp-0.3.4/setup.cfg`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/lsst/rsp/__init__.py` & `lsst-rsp-0.3.4/src/lsst/rsp/__init__.py`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/lsst/rsp/catalog.py` & `lsst-rsp-0.3.4/src/lsst/rsp/catalog.py`
...
### Comparing `lsst-rsp-0.3.3/src/lsst/rsp/forwarder.py` & `lsst-rsp-0.3.4/src/lsst/rsp/forwarder.py`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/lsst/rsp/log.py` & `lsst-rsp-0.3.4/src/lsst/rsp/log.py`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/lsst/rsp/utils.py` & `lsst-rsp-0.3.4/src/lsst/rsp/utils.py`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/lsst_rsp.egg-info/PKG-INFO` & `lsst-rsp-0.3.4/src/lsst_rsp.egg-info/PKG-INFO`
...
### Comparing `lsst-rsp-0.3.3/src/lsst_rsp.egg-info/SOURCES.txt` & `lsst-rsp-0.3.4/src/lsst_rsp.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/src/rubin_jupyter_utils/lab/notebook/__init__.py` & `lsst-rsp-0.3.4/src/rubin_jupyter_utils/lab/notebook/__init__.py`

 * *Files identical despite different names*

### Comparing `lsst-rsp-0.3.3/tox.ini` & `lsst-rsp-0.3.4/tox.ini`

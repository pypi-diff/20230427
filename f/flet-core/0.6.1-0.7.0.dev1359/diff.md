# Comparing `tmp/flet_core-0.6.1.tar.gz` & `tmp/flet_core-0.7.0.dev1359.tar.gz`
...
### Comparing `flet_core-0.6.1/src/flet_core/icon.py` & `flet_core-0.7.0.dev1359/src/flet_core/icon.py`

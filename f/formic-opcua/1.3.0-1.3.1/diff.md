# Comparing `tmp/formic_opcua-1.3.0.tar.gz` & `tmp/formic_opcua-1.3.1.tar.gz`

## Comparing `formic_opcua-1.3.0.tar` & `formic_opcua-1.3.1.tar`
...
### Comparing `formic_opcua-1.3.0/.pre-commit-config.yaml` & `formic_opcua-1.3.1/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/examples/opcua_client.py` & `formic_opcua-1.3.1/examples/opcua_client.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/examples/example_configs/opcua_config.yaml` & `formic_opcua-1.3.1/examples/example_configs/opcua_config.yaml`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/examples/example_configs/opcua_config_1.yaml` & `formic_opcua-1.3.1/examples/example_configs/opcua_config_1.yaml`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/examples/example_configs/opcua_config_2.yaml` & `formic_opcua-1.3.1/examples/example_configs/opcua_config_2.yaml`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/formic_opcua/client/async_opcua_client.py` & `formic_opcua-1.3.1/formic_opcua/client/opcua_client.py`
...
### Comparing `formic_opcua-1.3.0/formic_opcua/client/opcua_client.py` & `formic_opcua-1.3.1/formic_opcua/client/async_opcua_client.py`
...
### Comparing `formic_opcua-1.3.0/formic_opcua/core/parse.py` & `formic_opcua-1.3.1/formic_opcua/core/parse.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/formic_opcua/core/type_conversions.py` & `formic_opcua-1.3.1/formic_opcua/core/type_conversions.py`
...
### Comparing `formic_opcua-1.3.0/formic_opcua/scripts/formic_opcua_client.py` & `formic_opcua-1.3.1/formic_opcua/scripts/formic_opcua_client.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/formic_opcua/scripts/formic_opcua_server.py` & `formic_opcua-1.3.1/formic_opcua/scripts/formic_opcua_server.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/formic_opcua/server/opcua_server.py` & `formic_opcua-1.3.1/formic_opcua/server/opcua_server.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/hooks/add_issue_prefix.py` & `formic_opcua-1.3.1/hooks/add_issue_prefix.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/tests/test_server_config.py` & `formic_opcua-1.3.1/tests/test_server_config.py`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/.gitignore` & `formic_opcua-1.3.1/.gitignore`

 * *Files identical despite different names*

### Comparing `formic_opcua-1.3.0/pyproject.toml` & `formic_opcua-1.3.1/pyproject.toml`

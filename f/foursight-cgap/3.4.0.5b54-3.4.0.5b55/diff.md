# Comparing `tmp/foursight_cgap-3.4.0.5b54.tar.gz` & `tmp/foursight_cgap-3.4.0.5b55.tar.gz`
...
### Comparing `foursight_cgap-3.4.0.5b54/PKG-INFO` & `foursight_cgap-3.4.0.5b55/PKG-INFO`

# Comparing `tmp/client_GPT-0.2.1.tar.gz` & `tmp/client_GPT-0.2.2.tar.gz`
...
## Comparing `client_GPT-0.2.1.tar` & `client_GPT-0.2.2.tar`
...
### Comparing `client_GPT-0.2.1/setup.py` & `client_GPT-0.2.2/setup.py`
